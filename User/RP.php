...
<body>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div id="MailDiv">
                    <div class="form-field align-items-center">
                        ...
                        <input type="text" name="txtEmail" id="txtEmail" placeholder="Enter Registered Email Address" autocomplete="off" />
                    </div>
                    <br>
                    <div class="form-field align-items-center">
                    ...
                    <br>
                    <button style="width:100%; margin-top:10px" id="btnSignIp" class="btn btn-warning">Sign In <i class="fa fa-arrow-circle-right fa-lg"></i></button>
                </div>
                <div id="OTP">
                    <div class="form-field align-items-center">
	...
	<?php jsLink(); ?>
    <script src="user_js/rp.js"></script>
</body>
</html>